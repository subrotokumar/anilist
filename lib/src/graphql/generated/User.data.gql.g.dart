    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'isBlocked':
          ...
          break;
        case 'bans':
          result.bans.replace(serializers.deserialize(value,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case '__typename':
          ...
          break;
        case 'favouriteOrder':
          result.favouriteOrder = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
        case 'node':
...
class _$GUserData_Viewer extends GUserData_Viewer {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, previousNames.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'GUserData_Viewer')
          ...
          ..add('id', id)
          ..add('name', name)
          ..add('previousNames', previousNames)
          ..add('avatar', avatar)
...
class GUserData_ViewerBuilder
  ...
  GUserData_ViewerBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _id = $v.id;
      _name = $v.name;
      _previousNames = $v.previousNames?.toBuilder();
  ...
  _$GUserData_Viewer _build() {
    ...
    try {
      ...
      late String _$failedField;
      try {
        _$failedField = 'previousNames';
        _previousNames?.build();
...
class _$GUserData_Viewer_favourites_anime_edges
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, G__typename.hashCode);
    _$hash = $jc(_$hash, favouriteOrder.hashCode);
...
class GUserData_Viewer_favourites_anime_edgesBuilder
  ...
  int? _favouriteOrder;
  int? get favouriteOrder => _$this._favouriteOrder;
  ...
  GUserData_Viewer_favourites_anime_edgesBuilder get _$this {
    ...
    if ($v != null) {
      _G__typename = $v.G__typename;
      _favouriteOrder = $v.favouriteOrder;
